...
function App() {
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("html", { lang: "en", children: [
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("head", { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Linksasd, {})
    ] }),
...
var import_react4 = require("react"), import_jsx_runtime7 = require("react/jsx-runtime");
function SearchBar({ searchHandler }) {
  let searchRef = (0, import_react4.useRef)();
...
function FiltersBar({
  ...
  let [dates, setDates] = (0, import_react5.useState)({
    fromDate: "",
    toDate: ""
  }), onDateChange = (e) => {
...
function transaction_history() {
  ...
  let [filteredTransactions, setFilteredTransactions] = (0, import_react7.useState)([]), [filterValues, setFilterValues] = (0, import_react7.useState)({
    category: "",
    fromDate: "",
    toDate: ""
  }), [filters, setFilters] = (0, import_react7.useState)({
    category: !1,
    dates: !1,
    filtered: !1
  });
...
var import_react10 = require("react"), import_node2 = require("@remix-run/node"), import_react11 = require("@remix-run/react");
...
var import_jsx_runtime18 = require("react/jsx-runtime"), ModalForm = ({ closeHandler }) => {
  var _a;
  let [transactionType, setTransactionType] = (0, import_react9.useState)("income"), formRef = (0, import_react9.useRef)(), navigation = (0, import_react8.useTransition)(), actionData = (0, import_react8.useActionData)();
  ...
  }, [todaysDate, setTodaysDate] = (0, import_react9.useState)(
    new Date().toISOString().slice(0, 10)
  );
  return /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)(import_react8.Form, { ref: formRef, method: "post", replace: !0, children: [
...
var assets_manifest_default = { version: "837d24c7", entry: { module: "/build/entry.client-EMETW6ZU.js", imports: ["/build/_shared/chunk-7NBYS6LO.js", "/build/_shared/chunk-ND7GPMND.js"] }, routes: { root: { id: "root", parentId: void 0, path: "", index: void 0, caseSensitive: void 0, module: "/build/root-JUXYTFAI.js", imports: ["/build/_shared/chunk-SKZPSXXS.js"], hasAction: !1, hasLoader: !1, hasCatchBoundary: !1, hasErrorBoundary: !0 }, "routes/index": { id: "routes/index", parentId: "root", path: void 0, index: !0, caseSensitive: void 0, module: "/build/routes/index-LXW3IKH7.js", imports: ["/build/_shared/chunk-QN52TUBX.js"], hasAction: !0, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/transaction-history": { id: "routes/transaction-history", parentId: "root", path: "transaction-history", index: void 0, caseSensitive: void 0, module: "/build/routes/transaction-history-3E4YIWFO.js", imports: ["/build/_shared/chunk-QN52TUBX.js"], hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 } }, url: "/build/manifest-837D24C7.js" };
